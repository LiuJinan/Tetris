 ...
 *
 */
public class Type4 extends RectType {
	/**
	 * 倒7形方块四种变形
	 */
	...
	public void init(int x, int y) {
		...
		tp1[1].setX(x); tp1[1].setY(y - Rect.RECT_SIZE);
		tp1[2].setX(x); tp1[2].setY(y - 2 * Rect.RECT_SIZE);
		tp1[3].setX(x + Rect.RECT_SIZE); tp1[3].setY(y - 2 * Rect.RECT_SIZE);
		
		tp2[0].setX(x); tp2[0].setY(y - Rect.RECT_SIZE);
		tp2[1].setX(x + Rect.RECT_SIZE); tp2[1].setY(y - Rect.RECT_SIZE);
		tp2[2].setX(x + 2 * Rect.RECT_SIZE); tp2[2].setY(y -  Rect.RECT_SIZE);
		tp2[3].setX(x + 2 * Rect.RECT_SIZE); tp2[3].setY(y);
		
		tp3[0].setX(x); tp3[0].setY(y);
		tp3[1].setX(x + Rect.RECT_SIZE); tp3[1].setY(y);
		tp3[2].setX(x + Rect.RECT_SIZE); tp3[2].setY(y - Rect.RECT_SIZE);
		tp3[3].setX(x + Rect.RECT_SIZE); tp3[3].setY(y - 2 * Rect.RECT_SIZE);
		
		tp4[0].setX(x); tp4[0].setY(y);
		tp4[1].setX(x); tp4[1].setY(y - Rect.RECT_SIZE);
		tp4[2].setX(x + Rect.RECT_SIZE); tp4[2].setY(y);
		tp4[3].setX(x + 2 * Rect.RECT_SIZE); tp4[3].setY(y);
	}
}
