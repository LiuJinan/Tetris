 ...
 *
 */
public class Type6 extends RectType {
	/**
	 * 倒Z形方块四种变形
	 */
	...
	public void init(int x, int y) {
		...
		tp1[3].setX(x + 2 * Rect.RECT_SIZE); tp1[3].setY(y - Rect.RECT_SIZE);
		
		tp2[0].setX(x); tp2[0].setY(y - Rect.RECT_SIZE);
		tp2[1].setX(x); tp2[1].setY(y - 2 * Rect.RECT_SIZE);
		tp2[2].setX(x + Rect.RECT_SIZE); tp2[2].setY(y - Rect.RECT_SIZE);
		tp2[3].setX(x + Rect.RECT_SIZE); tp2[3].setY(y);
		...
		tp4[1].setX(x); tp4[1].setY(y - 2 * Rect.RECT_SIZE);
